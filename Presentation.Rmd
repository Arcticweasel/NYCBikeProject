...
- Einbeziehung aller Variablen außer Datum
- Hyperparameter:
  - Anzahl Epochen:   100 + k-fold cross validation
  - Batchsize:         20     
  - Anzahl Lags:        1
  - Anzahl Timesteps:   2
...
- RMSE mit `r daily_lstm_rmse` niedrig
  - Durchschnittlicher Fehler von rund `r round(daily_lstm_rmse)` Nutzern pro Tag
...
- RMSE des LSTM Netzes: `r round(daily_lstm_rmse)`
