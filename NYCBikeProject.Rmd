...
```{r}
#ARI für Bestiung der lags
arimax.Y <- as.numeric(hourly_chelsea_train$user_count)
arimax.X <- as.matrix(hourly_chelsea_train[,c(5:40)])
hourly_arimax <- auto.arima(arimax.Y, xreg = arimax.X)
hourly_arimax
