...
linreg <- lm(model, hourly_starts_nh)
summary(linreg)
```
...
x <- data.matrix(hourly_starts_nh[,-3])
y <- as.matrix(hourly_starts_nh[,3])
...
lasso_reg <- cv.glmnet(x, y, alpha = 1, nfolds = 3)
