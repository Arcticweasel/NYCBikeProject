...
hourly_test[,c(3, 7:105)] <- effectcoding(hourly_test[,c(4, 7:105)])
...
#Dummys effektkodieren
daily_neighborhood_test_nn[,c(11:20)] <- effectcoding(daily_neighborhood_test_nn[,c(11:20)])
```
...
```{r}
test.start <- as.POSIXct("2020-02-04")
...
nd <- normalize_data(df.train[,selected_columns], df.test[,selected_columns])
